...
Spring kotlin fun is project based on [Spring Boot Kotlin Sample Project](https://github.com/sdeleuze/spring-boot-kotlin-demo).

It is a simple playground for Kotlin, Spring and RxJava
